# Generated by Django 3.2.7 on 2021-10-07 03:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post', to='meet.activities')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_hobby', models.ManyToManyField(related_name='hobbysist', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Countries',
            fields=[
                ...
                ('user_hobby', models.ManyToManyField(related_name='citizen', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
